...
# updated by Sanjay Seshan for Stretch and Buster and rpi3b,3b+ - 2017-19
...
apt-get --force-yes -y install locales console-common ntp openssh-server less vim parted raspberrypi3-kernel pi-bluetooth
